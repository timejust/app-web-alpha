...
describe TravelStep do
  ...
  describe "create_google_event" do
    ...
    it "should create a google event on given calendar" do
      ...
      event = build(:tj_event)
      calendars = Timejust::Calendars.new(travel_step.user.email, travel_step.user.refresh_token)
      calendars.should_receive(:insert).with(
