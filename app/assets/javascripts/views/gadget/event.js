...
App.Views.EventView = Backbone.View.extend({
  ...
  showTravelNodesSelector: function(){
    ...
    if (this.travels_view) {
      ...
      this.travels_view = new App.Views.TravelsView({ el: $('#travels').get(0), 
          apiEventId: this.model.get('_id'), selectedEvent: this.selectedEvent, 
          ip: this.ip, eventView: this, base: this.base });
    }
  },
