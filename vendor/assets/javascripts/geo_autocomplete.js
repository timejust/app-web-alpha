 ...
 *
 * Requires jQuery Autocomplete plugin by Jorn Zaefferer - see http://bassistance.de/jquery-plugins/jquery-plugin-autocomplete/
...
$.fn.extend({
	geo_autocomplete: function(_geocoder, _options) {
		options = $.extend({}, $.Autocompleter.defaults, {
			...
			/*
			// Hacked not to show map on the result list
			...
			formatItem: function(_data, _i, _n, _value) {
			  return _data.formatted_address + '<br clear="both"/>';
		  }
		}, _options);
